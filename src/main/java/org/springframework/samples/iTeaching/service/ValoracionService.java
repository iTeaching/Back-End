...
public class ValoracionService {
	...
	public Optional<Valoracion> findValoracionByAlumnoAnuncio(Alumno alumno, Asignatura asignatura) throws DataAccessException {
		return valoracionRepository.findByAlumnoAsignatura(alumno, asignatura);
	}
	
	@Transactional(readOnly = true)
	public Collection<Valoracion> findValoracionByAnuncio(Asignatura asignatura) throws DataAccessException {
