...
<petclinic:layout pageName="Mi perfil">
						...
						<td><c:choose>
								<c:when test="${listaClase.aceptacionAlumno==false}">
									<button type="button" class="btn btn-secondary">
										<a class="button" href="/alumnos/aceptar/${listaClase.id}" style="text-decoration:none; color: white">Aceptar
											Clase</a>
									</button>
								</c:when>
							</c:choose>
						<button type="button" class="btn btn-secondary">
							<a style="text-decoration:none; color: white" class="button" href="/alumnos/cancelar/${listaClase.id}">Cancelar Clase</a></td>
						</button>
					</tr>
				</c:forEach>
			</tbody>
	...
	<!-- 	 <button type="button" class="btn btn-warning" style="border-color: #dab305; background-color: #dab305;" ><a class="button" href="/alumnos/nuevaClase" style="text-decoration:none; color: white">Solicitar
			...
			onclick="window.location.href='/alumnos/${alumno.id}/edit'">Editar </button>
	</form>
