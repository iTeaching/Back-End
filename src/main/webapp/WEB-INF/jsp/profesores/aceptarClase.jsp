...
<petclinic:layout pageName="profesores">
...
<%--             <form:input type="hidden" path="alumno.user.username"/> --%>
         ...
         <div class="form-group">
            <div style="margin-left:10px">
                <button type="submit" class="btn btn-warning" style="font-size:16px; color:white; border-color: #dab305; background-color: #dab305;">Aceptar Clase</button>
            </div>
        </div>
    </form:form>
    </div>
